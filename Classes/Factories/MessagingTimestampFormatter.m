...
@interface MessagingTimestampFormatter ()

@property (strong, nonatomic, readwrite) NSDateFormatter *dateFormatter;

@end

@implementation MessagingTimestampFormatter

#pragma mark - Singleton

+ (instancetype)sharedFormatter
{
    static MessagingTimestampFormatter *sharedFormatter = nil;
