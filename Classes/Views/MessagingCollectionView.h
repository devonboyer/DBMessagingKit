...
extern NSString * const kMessagingMovieCellIdentifier;
...
@interface MessagingCollectionView : UICollectionView <MessagingImageCellDelegate, MessagingTextCellDelegate, MessagingMovieCellDelegate>
