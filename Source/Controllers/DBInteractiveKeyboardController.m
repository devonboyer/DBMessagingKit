//
//  DBInteractiveKeyboardController.m
//
//
//  GitHub
...
NSString * const DBInteractiveKeyboardDidChangeFrameNotification = @"InteractiveKeyboardDidChangeFrameNotification";
NSString * const DBInteractiveKeyboardDidChangeFrameUserInfoKey = @"InteractiveKeyboardDidChangeFrameUserInfoKey";
...
@interface DBInteractiveKeyboardController ()

@property (weak, nonatomic) UIView *keyboardView;

@end

@implementation DBInteractiveKeyboardController
...
- (void)notifyKeyboardFrameNotificationForFrame:(CGRect)frame
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:DBInteractiveKeyboardDidChangeFrameNotification
                                                        object:self
                                                      userInfo:@{DBInteractiveKeyboardDidChangeFrameUserInfoKey : [NSValue valueWithCGRect:frame]}];
}
