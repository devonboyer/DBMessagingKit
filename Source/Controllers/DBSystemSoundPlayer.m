...
@implementation DBSystemSoundPlayer

+ (DBSystemSoundPlayer *)sharedPlayer
{
    static DBSystemSoundPlayer *sharedPlayer;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedPlayer = [[DBSystemSoundPlayer alloc] init];
    });
