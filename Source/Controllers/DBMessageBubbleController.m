...
@interface DBMessageBubbleController ()

@property (strong, nonatomic) NSMutableArray *messageGroupIndexPaths;

@property (weak, nonatomic) DBMessagingCollectionView *collectionView;
...
@implementation DBMessageBubbleController

- (instancetype)initWithCollectionView:(DBMessagingCollectionView *)collectionView
{
    NSParameterAssert(collectionView);
    NSParameterAssert([collectionView isKindOfClass:[DBMessagingCollectionView class]]);
...
- (instancetype)initWithCollectionView:(DBMessagingCollectionView *)collectionView outgoingBubbleColor:(UIColor *)outgoingMessageBubbleColor incomingBubbleColor:(UIColor *)incomingMessageBubbleColor
{
    NSParameterAssert(collectionView);
    NSParameterAssert([collectionView isKindOfClass:[DBMessagingCollectionView class]]);
...
- (void)setTopTemplateForConsecutiveGroup:(UIImage *)templateImage
{
    ...
    self.incomingTopMessageBubble = [DBMessageBubbleFactory incomingMessageBubbleImageWithColor:self.incomingMessageBubbleColor
                                                                               template:templateImage];
    self.outgoingTopMessageBubble = [DBMessageBubbleFactory outgoingMessageBubbleImageWithColor:self.outgoingMessageBubbleColor
                                                                               template:templateImage];
}
...
- (void)setMiddleTemplateForConsecutiveGroup:(UIImage *)templateImage
{
    ...
    self.incomingMiddleMessageBubble = [DBMessageBubbleFactory incomingMessageBubbleImageWithColor:self.incomingMessageBubbleColor
                                                                                  template:templateImage];
    self.outgoingMiddleMessageBubble = [DBMessageBubbleFactory outgoingMessageBubbleImageWithColor:self.outgoingMessageBubbleColor
                                                                                  template:templateImage];
}
...
- (void)setBottomTemplateForConsecutiveGroup:(UIImage *)templateImage
{
    ...
    self.incomingBottonMessageBubble = [DBMessageBubbleFactory incomingMessageBubbleImageWithColor:self.incomingMessageBubbleColor
                                                                                  template:templateImage];
    self.outgoingBottomMessageBubble = [DBMessageBubbleFactory outgoingMessageBubbleImageWithColor:self.outgoingMessageBubbleColor
                                                                                  template:templateImage];
}
...
- (void)setDefaultTemplate:(UIImage *)templateImage
{
    ...
    self.incomingDefaultMessageBubble = [DBMessageBubbleFactory incomingMessageBubbleImageWithColor:self.incomingMessageBubbleColor
                                                                               template:templateImage];
    self.outgoingDefaultMessageBubble = [DBMessageBubbleFactory outgoingMessageBubbleImageWithColor:self.outgoingMessageBubbleColor
                                                                               template:templateImage];
}
