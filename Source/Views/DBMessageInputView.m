...
@implementation DBMessageInputView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textView = [[DBMessagingInputTextView alloc] initWithFrame:CGRectMake(cameraButtonSize.width, CGRectGetHeight(self.frame) / 2.0 - initialTextViewHeight / 2.0, self.frame.size.width - cameraButtonSize.width - sendButtonSize.width - padding * 2.0, initialTextViewHeight)];
