...
/**
 *  An instance of 'DBMessagingTimestampFormatter' is a singleton object that provides an efficient means
 *  for creating attributed and non-attributed string representations of 'NSDate' objects.
 *  It is intended to be used as the method by which you display timestamps in a 'DBMessagingCollectionView'.
 */
@interface DBMessagingTimestampFormatter : NSObject

/**
 *  Returns the cached date formatter object used by the 'IGChatTimestampFormatter' shared instance.
 */
...
/**
 *  Returns a string representation of day, month, and year components of the given date formatted in the current locale.
 *
 *  @param date The date to format.
 *
 *  @return A formatted string representation of the day, month, and time components.
 */
